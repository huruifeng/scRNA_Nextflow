...
option_list <- list(
  make_option(opt_str = c("-i","--in_pwd"),
              type = "character",
              default = NULL,
              help = "Input pathway",
              metavar = "character"),
...
if(is.null(args$in_pwd)) {
  pwd <- system.file("testdata/well1.h5", package = "H5MANIPULATOR")
...
if(!file.exists(pwd)) {
  stm(paste0("ERROR: Cannot find pathway directory:", in_pwd))
  stop()
}
...
scrna.combined <- RenameIdents(scrna.combined, `0` = "Mip_Serotonergic_Clock", `1` = "Tm20", `2` = "Photoreceptor like", `3` = "TmY5a_TmY14", `4` = "DM3", `5` = "PM1_Pm2", `6` = "T4_T5", `7` = "T2_T3", `8` = "Astrocyte-Like_Ensheating glia", `9` = "Gamma Kenyon cell", `10` = "Dopaminergic PAM neurons", `11` = "Mi1", `12` = "C2_C3 neurons", `13` = "Adult fat body_Glial cells", `14` = "Transmedullary neuron Tm9", `15` = "Alpha_beta Kenyon cell", `16` = "Mi15_Tmy8_T", `17` = "Transmedullary Neurons", `18` = "MBON_Hemocytes", `19` = "LC12_LC17", `20` = "Mi15", `21` = "Columnar neuron T1", `22` = "Dm8", `23` = "Alpha_beta Kenyon cell", `24` = "Tm2_L neurons", `25` = "Lawf 1 and 2", `26` = "Dm8_Tm5c", `27` = "Tm1_Tm4_Tm20", `28` = "Pox neuron", `29` = "Lai_Tm1")
